...
public class Cub {
	...
	public Cub(double x, double y, double z, double W, double H, double D,
			Color fill, Color contur) {
		this.W = W;
		this.H = H;
		this.D = D;
		this.x = x;
	...
	public void calc_points() {
		Px = new double[] { -W + x, -W + x, W + x, W + x, -W + x, -W + x,
				W + x, W + x }; // real x-coordinate, 8 points
		Py = new double[] { -H + y, H + y, H + y, -H + y, -H + y, H + y, H + y,
				-H + y }; // real y-coordinate, 8 points
